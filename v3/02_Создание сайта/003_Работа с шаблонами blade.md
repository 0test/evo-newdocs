...
@endsection 
```
Какой спосбо выбрать - вопрос исключительно вашего удобства и количества содержимого.
...
> В `@include` можно передавать данные, подробности в расширенном материае про шаблонизацию.
