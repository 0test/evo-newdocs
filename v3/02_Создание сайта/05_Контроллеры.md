...
```
Мы добавили параметр `api` для сниппета DocLister, чтобы он отдал строку, а не html. Кодируем это строку так, чтобы на выходе получился массив.
...
Подробности, примеры работы и прочую информацию  про контроллеры вы можете найти в документации Ларавел и в расширенном материале "[Контроллеры в Evolution CMS](/v3/03_%D0%9F%D0%BE%D0%B4%D1%80%D0%BE%D0%B1%D0%BD%D0%B5%D0%B5/03_%D0%9A%D0%BE%D0%BD%D1%82%D1%80%D0%BE%D0%BB%D0%BB%D0%B5%D1%80%D1%8B%20%D0%B2%20Evolution%20CMS.md)".