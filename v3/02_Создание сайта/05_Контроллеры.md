...
> В документации к Моделям мы сделаем всё значительно проще и красивей.
...
Дальше работаем с переданными значениями и выводим данные в нужном виде:
